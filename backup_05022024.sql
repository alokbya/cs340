...
--
-- Host: classmysql.engr.oregonstate.edu    Database: cs340_alokbya
-- ------------------------------------------------------
...
INSERT INTO `Customers` VALUES (1,'Bike World','60025 Bollinger Canyon Road','','San Ramon','California','94583',0.00),(2,'Metro Sports','482505 Warm Springs Blvd.','','Fremont','California','94536',0.00),(3,'Alaaddin','200 E Colfax Ave','','Denver','Colorado','80203',0.00);
...
LOCK TABLES `customers` WRITE;
/*!40000 ALTER TABLE `customers` DISABLE KEYS */;
INSERT INTO `customers` VALUES (2,'Ayush',26),(3,'Xipen',25);
/*!40000 ALTER TABLE `customers` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `diagnostic` VALUES (1,'MySQL is working for myONID!');
...
INSERT INTO `orders` VALUES (3,'Tshirt',3),(4,'Jacket',2);
...
-- Dump completed on 2024-05-02 20:07:59
